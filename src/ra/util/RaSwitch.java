...
public class RaSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case RaPackage.SPECIALISATION: {
				Specialisation specialisation = (Specialisation)theEObject;
				T result = caseSpecialisation(specialisation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RaPackage.COURSE_LIST: {
				CourseList courseList = (CourseList)theEObject;
				T result = caseCourseList(courseList);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case RaPackage.SEMESTER_COURSE_LIST: {
				SemesterCourseList semesterCourseList = (SemesterCourseList)theEObject;
				T result = caseSemesterCourseList(semesterCourseList);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Course List</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Course List</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCourseList(CourseList object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Semester Course List</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Semester Course List</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSemesterCourseList(SemesterCourseList object) {
		return null;
	}
