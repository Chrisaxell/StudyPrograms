...
public class RaFactoryImpl extends EFactoryImpl implements RaFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case RaPackage.PROGRAMME: return createProgramme();
			case RaPackage.SPECIALISATION: return createSpecialisation();
			case RaPackage.COURSE_LIST: return createCourseList();
			case RaPackage.SEMESTER: return createSemester();
			case RaPackage.SEMESTER_COURSE_LIST: return createSemesterCourseList();
	...
	public CourseList createCourseList() {
		CourseListImpl courseList = new CourseListImpl();
		return courseList;
	}
	 ...
	 */
	@Override
	public SemesterCourseList createSemesterCourseList() {
		SemesterCourseListImpl semesterCourseList = new SemesterCourseListImpl();
